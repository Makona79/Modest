...
// if (isMobile.any()) {
// 	let menuParents = document.querySelectorAll('.meet-page__item');
...
// 	}
// } else {
let members = document.querySelectorAll('.meet-page__item');
...
function mapInit(n = 1) {
	...
	var locations = [
		[new google.maps.LatLng(40.71248833205591, -73.7660214273649)],
